...
public final class L {
	public final static String TAG = "EBGVoip";
	...
	private static String packageName = "com.twm.ebgvoip.nicall";
	private static String appName = "NiCall";
	private static String logFileName = "nicalllog.txt";
	/**  DB_PATH = /data/data/com.twm.ebgvoip.nicall */
